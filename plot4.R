...
plot(data_select$Date_time,data_select$Voltage,type="n",ylab="Voltage",xlab="datetime")
lines(data_select$Date_time,data_select$Voltage)
...
plot(data_select$Date_time,data_select$Global_reactive_power,type="n",ylab="Global_reactive_power",xlab="datetime")
lines(data_select$Date_time,data_select$Global_reactive_power)
